        ...
        <div className="block lg:flex min-h-screen">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-3 lg:space-y-4">
              {contactInfo.map((contact) => (
                <motion.div key={contact.type} whileHover={{ scale: 1.02, x: 8 }} className="group">
                  <div className="bg-slate-800/60 hover:bg-slate-700/60 border border-slate-600/50 hover:border-emerald-400/50 rounded-xl p-3 lg:p-4 transition-all duration-300">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-white text-sm font-medium break-all sm:truncate">{contact.value}</div>
                        </div>
                      </a>
                      <motion.button
          ...
          <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
            <div className="max-w-4xl mx-auto space-y-12 lg:space-y-16">
                  ...
                  <Card className="p-4 sm:p-6 lg:p-8 bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 group-hover:border-emerald-400/30 transition-all duration-500">
                    <CardContent className="p-0">
                      ...
                      <p className="text-base lg:text-lg leading-relaxed text-slate-200">
                        ...
                        real-world settings, contribute to innovative teams, and continue growing as a problem-solver
                        and lifelong learner. Outside coding, I enjoy strategy games that sharpen my analytical
                        thinking.
                      </p>
                    </CardContent>
                  </Card>
              ...
              <motion.section variants={itemVariants}>
                <motion.h2 className="text-2xl sm:text-3xl font-bold mb-6 lg:mb-8 text-slate-200">Tech Stack</motion.h2>
                      ...
                      <Card className="h-full p-4 lg:p-6 bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 group-hover:border-emerald-400/30 transition-all duration-500">
                        <CardContent className="p-0">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="font-semibold text-white text-sm lg:text-base">{category.title}</h3>
                          </div>
                    ...
                    >
                      <Card className="p-3 lg:p-4 text-center bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 group-hover:border-emerald-400/30 transition-all duration-500">
                        <CardContent className="p-0">
                          ...
                          <p className="text-xs lg:text-sm font-medium text-slate-200">{skill.name}</p>
                        </CardContent>
                      </Card>
                    </motion.div>
                  ))}
          ...
          <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
            <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[90vh] overflow-y-auto bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 m-4">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-300 leading-relaxed text-sm lg:text-base">{selectedProject.description}</p>
